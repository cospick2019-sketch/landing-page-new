      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-6 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-stretch">
          ...
          <BlurFade delay={0.1} className="h-full">
            <div className="relative h-full flex flex-col justify-between p-7 md:p-12 lg:p-14 rounded-2xl md:rounded-[2.5rem] bg-white/70 backdrop-blur-xl border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden group hover:shadow-[0_20px_40px_rgba(99,102,241,0.08)] hover:-translate-y-1 transition-all duration-500">
              ...
              <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} className="relative z-10 flex flex-col items-start h-full">
                ...
                <motion.div variants={itemVariants} className="mb-8 p-4 bg-gradient-to-br from-indigo-50 to-white rounded-2xl border border-indigo-100 shadow-[0_4px_20px_rgb(99,102,241,0.05)] group-hover:scale-110 transition-transform duration-500">
          ...
          <BlurFade delay={0.3} className="h-full">
            <div className="relative h-full flex flex-col justify-between p-7 md:p-12 lg:p-14 rounded-2xl md:rounded-[2.5rem] bg-[#030513] border border-white/10 shadow-[0_8px_40px_rgb(0,0,0,0.2)] overflow-hidden group hover:shadow-[0_20px_50px_rgba(99,102,241,0.2)] hover:-translate-y-1 transition-all duration-500">
              ...
              <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} className="relative z-10 flex flex-col h-full">
                ...
                <div className="pb-6 md:pb-12 flex-grow flex flex-col items-start">

                  {/* Unified Icon Style matching the Left Card */}
                  <motion.div variants={itemVariants} className="mb-8 p-4 bg-gradient-to-br from-indigo-900/40 to-indigo-950/40 rounded-2xl border border-indigo-500/30 shadow-[0_4px_20px_rgb(99,102,241,0.1)] group-hover:scale-110 transition-transform duration-500">
                ...
                <motion.div variants={itemVariants} className="pt-6 md:pt-12 mt-auto w-full relative">
