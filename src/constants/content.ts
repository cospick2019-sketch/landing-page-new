...
export const SECTION_PRICING = {
  ...
  baseFeatures: [
    "페이지 기획 및 카피라이팅 포함",
    "반응형 웹 디자인",
    "소스코드 전체 제공 (zip 또는 GitHub)",
    "서버 이전 자유 · 특정 호스팅 종속 없음",
    "구글 스프레드시트 문의 관리 연동",
    "관리자 페이지 제공*",
    "기본 유지보수 1개월",
    "네이버 웹마스터 도구 설정 지원",
...
export const SECTION_FAQ = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "네, 전혀 문제없습니다. 오히려 대부분의 고객분들이 기획서 없이 시작하십니다.\n제품 정보와 특장점만 간단히 알려주시면, 저희가 고객 심리를 분석해 매출로 이어지는 페이지를 기획부터 디자인까지 완성해 드립니다.",
    },
    {
      q: "서비스를 이용하면 실제로 효과가 있을까요?",
      a: "저희 대표는 10년간 직접 이커머스 사업을 운영하며\n수십억 원의 광고비를 집행해 온 실전 경험이 있습니다.\n그 과정에서 축적한 데이터와 '잘 팔리는 구조'의 노하우를\n그대로 대표님의 페이지에 적용하기 때문에,\n효과 없으면 100% 환불 공약도 자신 있게 걸 수 있는 것입니다.",
    },
    {
      q: "수정은 몇 번이나 가능한가요?",
      a: "텍스트나 이미지 교체 같은 간단한 수정은\n런칭 후 30일 이내 횟수 제한 없이 무료로 진행해 드립니다.\n전체 기획 방향을 바꾸는 큰 수정은 상호 협의 후 진행하고 있습니다.",
    },
    {
      q: "제작기간은 얼마나 걸리나요?",
    ...
    {
      q: "소스코드는 어떻게 받나요?",
      a: "완성된 프로젝트 전체를 zip 파일 또는 GitHub private repo로 전달해 드립니다.\nNext.js 기반 표준 프로젝트라 고객님 소유의 어느 호스팅에든 바로 배포할 수 있으며, 특정 빌더(워드프레스·아임웹 등)에 종속되지 않습니다. 이후에도 다른 개발자가 이어받아 수정하실 수 있습니다.",
    },
    {
      q: "나중에 다른 호스팅으로 옮길 수 있나요?",
      a: "네, 언제든 가능합니다. Vercel, Netlify, 카페24, AWS, 자체 서버 등 어느 환경으로든 이전할 수 있는 구조로 제작해 드립니다.\n문의 관리에 사용되는 구글 스프레드시트 역시 고객님 구글 계정으로 소유권 이전이 가능하여, 장기적으로 저희에게 의존하지 않으셔도 됩니다.",
    },
  ],
} as const;
